...
echo "<h2>For SBC Release 8.3</h2><br />";
echo "Download the <a href='downloads/S3_8.3_hdrrule_for_basic_A2.cli'>S3-8.3-Header-Rule.cli</a> script to the S3.";
echo "<dl>";
echo "<dt><strong>Step 1:</strong> Download Script</dt>";
echo "<dd class='indent'>Download script to SBC</dd>";
echo "<dt><strong>Step 2:</strong> CHMOD script</dt>";
echo "<dd class='indent'> In the same directory that the script was moved to, on the SBC, you will need to change the file permissions.  On the command line type: <br />";
echo "<textarea name='nowrap' rows='1' cols='102'>chmod 755 S3-8.3-Header-Rule.cli</textarea></dd>"; 
echo "<dt><strong>Step 3:</strong> Run the script</dt>";
echo "<dd class='indent'> From the command line of the SBC type the following to excute the script";
echo "<textarea name='nowrap' rows='1' cols='102'>./S3-8.3-Header-Rule.cli</textarea></dd>";
echo "</dl>";
echo "<br /><br />";
...
print "cli hdrrule edit pass_contact method ALL method-type both  header-element parameter header contact param-type hdr param ALL operation PASS-VALID" . "\n";
...
print "cli hdrrule add pass_from_uri" . "\n";
print "cli hdrrule edit pass_from_uri method ALL method-type both  header-element parameter header from  param-type uri param all operation PASS-VALID       " . "\n";
print "cli hdrpolicy edit System_Header_Policy_Profile add pass_from_uri ruletype DESTHDRRULE" . "\n";
print "cli hdrrule add Resource-Priority" . "\n";
print "cli hdrrule edit Resource-Priority method ALL header-element fullheader method-type both response ALL header Resource-Priority operation PASS-IGN-ERR" . "\n";
print "cli hdrpolicy edit System_Header_Policy_Profile add Resource-Priority ruletype DESTHDRRULE" . "\n";
print "cli hdrrule add maddr_modify" . "\n";
print "cli hdrrule edit maddr_modify method ALL method-type req header-element parameter header contact param-type uri param maddr operation MODIFY substituted-value [DST.REALM.RSA]" . "\n";
print "cli hdrpolicy edit System_Header_Policy_Profile add  maddr_modify ruletype DESTHDRRULE" . "\n";
echo "</textarea>" ."\n";
