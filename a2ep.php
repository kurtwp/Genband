...
// --- End Point URI ---
	if ($_POST['epURI'] != "") {
		$epURI = explode(",",$_POST['epURI']);
		$arrayUCount = count($epURI);
	}
...
//---  PHP Validation Sections ---  	
	...
	$fail .= compareURICount($arrayUCount,$arrayPCount);
...
//--- End Validation Section ---
	...
	if ($fail == "") {
		...
		for ($k=0; $k<$arrayPCount; $k++) {
			...
			if ($epURI != "") { 
				print $cliEdit . $endPoint . "uri " . $epURI[$k] . "\n";
			}
...
<div class='field'>
	...
	<input type='text' class='input' size="10" maxlength='150' name='epURI' /><br />
</div>
<div class='field'>
