...
echo "Download the <a href='downloads/S3_8.2_hdrrule_for_basic_A1.cli'>S3-8.2-Header-Rule.cli</a> script to the S3.";
echo "<dl>";
...
echo "<textarea name='nowrap' rows='1' cols='102'>chmod 755 S3-8.2-Header-Rule.cli</textarea></dd>"; 
...
echo "<textarea name='nowrap' rows='1' cols='102'>./S3-8.2-Header-Rule.cli</textarea></dd>";
echo "</dl>";
echo "<br /><br />";
